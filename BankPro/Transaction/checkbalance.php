...
<div class="columns">
		<div class="tops column is-offset-4">
			...
			<input type="text" class="input is-primary  column is-5" placeholder="Account Number"><br>


			<label for="" class="is-size-3 has-text-white">Pin Number </label><br>
			<input type="text" class="input is-primary column is-5" placeholder="Pin Number"><br>
