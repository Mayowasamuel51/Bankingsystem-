...
<div class="columns ml-4 mt-5">
	<div class="card column is-6">
		...
		<div class="card-content">
			...
			<?php
				...
				if($row_data = mysqli_fetch_assoc($query_database)){
					...
					echo "<p class='is-size-5 has-text-weight-semibold pr-3 pt-1'>Total Balance : ".$_SESSION['totalamount']."</p>";
				}
		...
		<div>
			<form action="">
				<button class="button is-success is-size-6 ml-4">Recharge Your Line</button>
				<button class="button is-success has-background-black is-size-6 ml-4">Make Transfer</button>
			</form>
		</div>
	</div>
...
<button class="button is-success is-outlined mt-3 ml-5">logout </button>
